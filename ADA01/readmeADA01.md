...
- Para compilar el programa se ejecuta por medio de la linea de comandos. 
   ...
   Luego, ingresamos los siguientes comandos en la terminal.
    ...
    REFLEXIÓN:
    Al inicio, la actividad resultó un tanto compleja, especialmente al integrar la lectura de archivos con las condiciones necesarias para separar correctamente operadores y números dentro de cada expresión. Fue necesario investigar y comprender mejor cómo implementar el recorrido línea por línea del archivo, así como las funciones básicas para manejar una pila con memoria dinámica.

    A lo largo del desarrollo, pudimos identificar y aplicar algoritmos conocidos, como Shunting Yard, que resultan fundamentales para la conversión de notación infija a postfija. Esto no solo facilitó la resolución del problema, sino que también nos permitió comprender la utilidad real de estos métodos dentro del procesamiento de expresiones matemáticas.

    Finalmente, el proceso nos ayudó a fortalecer nuestro entendimiento sobre estructuras de datos, manejo de archivos y la importancia de elegir el algoritmo correcto para cada tarea. Gracias a ello, logramos completar satisfactoriamente el programa y adquirir nuevos conocimientos que serán útiles para futuros proyectos.